...
public class FlintOpenSearchMetadataLog implements FlintMetadataLog<FlintMetadataLogEntry> {
  ...
  private final FlintMetadataLogService flintMetadataLogService;
  ...
  public FlintOpenSearchMetadataLog(FlintMetadataLogService flintMetadataLogService, String flintIndexName, String metaLogIndexName) {
    this.flintMetadataLogService = flintMetadataLogService;
  ...
  public Optional<FlintMetadataLogEntry> getLatest() {
    ...
    try (IRestHighLevelClient client = (IRestHighLevelClient) flintMetadataLogService.createClient()) {
